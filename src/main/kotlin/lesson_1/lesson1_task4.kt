...
fun main() {
    /**
     * Запиши в переменные соответствующие значения, явно указывая их тип. Для всех переменных выбирай тип данных, занимающий наименьшее возможное место в памяти, при этом вмещающий нужное значение (например для числа 0 выбирай тип Byte и так далее).
     *
     * Список переменных:
